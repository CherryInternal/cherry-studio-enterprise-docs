---
title: Docker 部署
description: "使用 Docker 和 Docker Compose 部署 Cherry Studio Enterprise，支持双服务集成、数据持久化和健康检查。"
---
...
> 如需配置 Casdoor 单点登录 (SSO)，请参阅 <DynamicLink href="/[lang]/docs/setup/advanced/sso">单点登录配置</DynamicLink>。
...
- <DynamicLink href="/[lang]/docs/setup/advanced/sso">单点登录配置</DynamicLink> - SSO 单点登录配置
