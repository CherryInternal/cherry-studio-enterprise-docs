...
| 线路 | 镜像地址 |
|---|---|
| **国内镜像**（推荐中国大陆用户使用） | `docker-registry.cherry-ai.com/public/cherry-studio-enterprise-api:v0.4.10` |
| **Docker Hub**（海外用户） | `cherrystudio/cherry-studio-enterprise-api:v0.4.10` |
