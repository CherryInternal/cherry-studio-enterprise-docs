...
> For Casdoor SSO configuration, see [SSO configuration](../advanced/sso).
...
- [Helm deployment guide](./helm) - Deploy to Kubernetes
- [Database configuration guide](../advanced/database) - PostgreSQL configuration details
- [SSO configuration](../advanced/sso) - SSO setup
